...
public class JFrame_Battleship extends javax.swing.JFrame {
    ...
    public class ButtonListenerPlayer implements ActionListener {
      ...
      //      for (int j = 0; j < ROWS; j++){
              if(e.getSource()==buttons_Player[i]){ //gameButtons[i][j] was clicked
               //Your code here
    ...
    public void ButtonTablePlayer() {
        ...
        for(int i=0;i<a;i++){
            for(int j=0;j<a;j++){
                //create new JButton
                buttons_Player[i][j] = new JButton(Integer.toString(i)+" "+Integer.toString(j));
    ...
    public class ButtonListenerAI implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e){
            for (int i = 0; i < a; i++){
      //        for (int j = 0; j < ROWS; j++){
                if(e.getSource()==buttons_AI[i]){ //gameButtons[i][j] was clicked
                //Your code here
                System.out.println(i);
                }
            }
    ...
    public void ButtonTableAI() {
        ...
        for(int i=0;i<a;i++){
            for(int j=0;j<a;j++){
                //create new object
                buttons_AI[i][j] = new JButton(Integer.toString(i)+" "+Integer.toString(j));
                buttons_AI[i][j].setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
                buttons_AI[i][j].addActionListener(clk);
